...
def cleanup_connections():
    """Cleanup all DuckDB connections after each test - manually close and clear pool."""
    yield
...
def test_invalid_table_name_select(simple_int_dataframe):
    """
    ...
    # Insert test data
    handler.insert_df("safe_table", simple_int_dataframe, ["id"])
    ...
    df_filtered = handler.query_with_pandas("SELECT * FROM safe_table WHERE id > 1")
...
def test_large_dataset():
    """
    Example 20: Handling larger datasets.
