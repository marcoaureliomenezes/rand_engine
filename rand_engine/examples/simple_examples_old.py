...
class RandSpecs:
        ...
        **Complexity Level: ★★☆☆☆ (Intermediate)** - Introduces complex patterns and weighted distributions.
        ...
        return {
                "sku": dict(method="complex_distincts", kwargs=dict(
                    ...
                    replacement="x",
                    templates=[
                        dict(method="integers", kwargs=dict(min=1000, max=9999, int_type="int32"))
                    ]
                )),
    ...
    def orders(cls) -> Dict[str, Any]:
        ...
        **Complexity Level: ★★★☆☆ (Advanced)** - Introduces UUID4, timestamps, and correlated columns.
        ...
        """
        return {
                "order_id": dict(method="uuid4", kwargs={}),
        ...
        **Complexity Level: ★★★★☆ (Expert)** - Demonstrates complex_distincts with parms dict in templates.
        ...
        return {
                "invoice_number": dict(method="complex_distincts", kwargs=dict(
                    ...
                    replacement="x",
                    templates=[
                        dict(method="distincts", kwargs=dict(distincts=["2023", "2024"])),
                        dict(method="int_zfilled", kwargs=dict(length=5))
                    ]
                )),
        ...
        **Complexity Level: ★★★★☆ (Expert)** - Demonstrates distincts_map for correlated data.
        ...
        return {
                "tracking_number": dict(method="complex_distincts", kwargs=dict(
                    ...
                    replacement="x",
                    templates=[
                        dict(method="int_zfilled", kwargs=dict(length=10))
                    ]
                )),
