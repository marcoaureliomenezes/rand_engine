...
class SparkRandSpecs:
    ...
    IMPO        return {
            "shipment_id": dict(method="zint", kwargs=dict(length=10)),
            ...
            "ship_date": dict(method="dates", kwargs=dict(start="2024-01-01", end="2024-10-01", formato="%Y-%m-%d")),
            "estimated_delivery": dict(method="dates", kwargs=dict(start="2024-01-05", end="2024-10-18", formato="%Y-%m-%d"))
        }ark API Differences from DataGenerator:
    ---------------------------------------------------
    - Use 'zint' instead of 'int_zfilled'
    - Use 'std' instead of 'stddev' in floats_normal
    - Use 'formato' instead of 'format' in dates
    ...
    def customers(cls) -> Dict[str, Any]:
        ...
        **Complexity Level: ★☆☆☆☆ (Basic)** - Perfect for learning Spark generation.
        ...
        Demonstrates:
        - zint: Zero-filled integers (Spark equivalent of int_zfilled)
        ...
        """
        return {
            "customer_id": dict(method="zint", kwargs=dict(length=6)),
    ...
    def products(cls) -> Dict[str, Any]:
        ...
        **Complexity Level: ★★☆☆☆ (Intermediate)** - Shows floats_normal and distincts_prop.
        ...
        """
        return {
            "product_id": dict(method="zint", kwargs=dict(length=6)),
    ...
    def orders(cls) -> Dict[str, Any]:
        ...
        **Complexity Level: ★★★☆☆ (Advanced)** - Shows date generation with formato parameter.
        
        Demonstrates:
        - uuid4: Order identifiers
        - dates: Date generation with formato parameter (Spark-specific)
        ...
        - order_date: Dates from 2023-2024 (formato parameter)
        ...
        """
        return {
            "order_id": dict(method="zint", kwargs=dict(length=8)),
    ...
    def transactions(cls) -> Dict[str, Any]:
        ...
        **Complexity Level: ★★☆☆☆ (Intermediate)** - Shows negative integers and timestamp handling.
        ...
        Demonstrates:
        - zint: Zero-filled transaction IDs
        ...
        return {
            ...
            "transaction_date": dict(method="dates", kwargs=dict(start="2024-01-01", end="2024-10-18", formato="%Y-%m-%d")),
    ...
    def employees(cls) -> Dict[str, Any]:
        ...
        **Complexity Level: ★★★☆☆ (Advanced)** - Shows salary distributions and date handling.
        ...
        Demonstrates:
        - zint: Employee identifiers
        - dates: Hire dates with formato parameter
        ...
        - hire_date: Dates from 2020-2024 (formato parameter)
        ...
        """
        return {
            "employee_id": dict(method="zint", kwargs=dict(length=5)),
            "hire_date": dict(method="dates", kwargs=dict(start="2020-01-01", end="2024-12-31", formato="%Y-%m-%d")),
    ...
    def devices(cls) -> Dict[str, Any]:
        ...
        **Complexity Level: ★★★★☆ (Expert)** - Shows complex IoT data generation.
        ...
        return {
            ...
            "last_ping": dict(method="dates", kwargs=dict(start="2024-10-01", end="2024-10-18", formato="%Y-%m-%d"))
        }
    ...
    def users(cls) -> Dict[str, Any]:
        ...
        **Complexity Level: ★★★☆☆ (Advanced)** - Shows activity distributions and plans.
        ...
        Demonstrates:
        - zint: User identifiers
        - distincts: Usernames
        - distincts_prop: Weighted subscription plans
        - dates: Signup dates with formato parameter
        ...
        - signup_date: Dates from 2022-2024 (formato parameter)
        ...
        """
        return {
            "user_id": dict(method="zint", kwargs=dict(length=7)),
            ...
            "signup_date": dict(method="dates", kwargs=dict(start="2022-01-01", end="2024-12-31", formato="%Y-%m-%d")),
    ...
    def invoices(cls) -> Dict[str, Any]:
        ...
        **Complexity Level: ★★★☆☆ (Advanced)** - Shows invoice tracking and amounts.
        ...
        Demonstrates:
        - zint: Invoice numbers
        - dates: Issue and due dates with formato parameter
        ...
        - issue_date: Dates from 2023 (formato parameter)
        - due_date: Dates from 2024 (formato parameter)
        ...
        """
        return {
            "invoice_number": dict(method="zint", kwargs=dict(length=8)),
            "issue_date": dict(method="dates", kwargs=dict(start="2023-01-01", end="2023-12-31", formato="%Y-%m-%d")),
            "due_date": dict(method="dates", kwargs=dict(start="2024-01-01", end="2024-12-31", formato="%Y-%m-%d")),
    ...
    def shipments(cls) -> Dict[str, Any]:
        ...
        **Complexity Level: ★★★☆☆ (Advanced)** - Shows tracking and weight data.
        ...
        - ship_date: Dates from Jan-Oct 2024 (formato parameter)
        - estimated_delivery: Dates from Jan-Oct 2024 (formato parameter)
        ...
        """
        return {
            "tracking_number": dict(method="zint", kwargs=dict(length=10)),
    ...
    def events(cls) -> Dict[str, Any]:
        ...
        **Complexity Level: ★★★☆☆ (Advanced)** - Shows event tracking and severity.
        ...
        return {
            ...
            "timestamp": dict(method="dates", kwargs=dict(start="2024-10-01", end="2024-10-18", formato="%Y-%m-%d")),
