...
class SparkCore:
  ...
  @staticmethod
  def gen_unix_timestamps(spark, F, df, col_name, start="1970-01-01", end="2023-01-01", formato="%Y-%m-%d"):
  ...
  def gen_dates(spark, F, df, col_name, start="1970-01-01", end="2023-01-01", formato="%Y-%m-%d"):
    ...
    df = SparkCore.gen_unix_timestamps(spark, F, df, col_name, start=start, end=end, formato=formato)
